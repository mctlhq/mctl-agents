...
* **agents:** bound DevLoopWorkflow merge watch with continue_as_new ([b70f579](https://github.com/mctlhq/mctl-agents/commit/b70f579bb4f0c6d428f35dba0cf5725ce8b07e3b))
* **agents:** issue-196-feat-governance-agent-execution-identity ([3215a1c](https://github.com/mctlhq/mctl-agents/commit/3215a1ce5b70bd020105c7b4867df929f5574f71))
* **agents:** issue-267-feat-work-context-resume-investigator-fr ([3ed4a17](https://github.com/mctlhq/mctl-agents/commit/3ed4a17c4f7540656cb24b7f59973e3676c638c0))
* **agents:** issue-305-add-repository-scoped-declarative-servic ([ee1f5ad](https://github.com/mctlhq/mctl-agents/commit/ee1f5ad7837eb654ad9e9ed9545068e995f55d8f))
* **agents:** issue-333-feat-human-input-durable-agent-clarifica ([7ed8498](https://github.com/mctlhq/mctl-agents/commit/7ed8498f6bd8e9530455566f5953c9e90db2427d))
* **agents:** issue-404-devloopworkflow-never-calls-continue-as-v2 ([2713a7d](https://github.com/mctlhq/mctl-agents/commit/2713a7d3bb7b73d6ee26e049d86294e26061ca49))
* **governance:** runtime policy checkpoint before agent side effects ([be0119e](https://github.com/mctlhq/mctl-agents/commit/be0119eabc78dc8d7f7b4995b210f20a0de22013))
* **governance:** runtime policy checkpoint before agent side effects ([0227bdf](https://github.com/mctlhq/mctl-agents/commit/0227bdf293e622e3989bf018d782959e332a9a92)), closes [#197](https://github.com/mctlhq/mctl-agents/issues/197)
* **implement:** record why an attempt never started and clamp admission to the claim mutex ([e718ebe](https://github.com/mctlhq/mctl-agents/commit/e718ebeefb05eb44d2f3b85f91ebcaeebafe6c95))
* **implement:** record why an implement attempt never started and clamp admission to the claim mutex ([36fcca4](https://github.com/mctlhq/mctl-agents/commit/36fcca411ed4ef2e2bf3685d21898d44dbd8ff0f))
* **observability:** end-to-end execution traces (code and offline part) ([bd1cbdb](https://github.com/mctlhq/mctl-agents/commit/bd1cbdb1a5fcfabd5a4be404534b8aca504f56d8))
* **observability:** execution trace core and Temporal -&gt; Argo -&gt; pod propagation ([c3544d2](https://github.com/mctlhq/mctl-agents/commit/c3544d23e81a98ea8e6b2b4a83402d51d3dd18a1))
* **observability:** model, tool, GitHub, artifact and policy spans in agent pods ([0f8c2db](https://github.com/mctlhq/mctl-agents/commit/0f8c2db0c4c5ba89622d22ed37d29eed5c6cb016))
* **policy:** durable single-use approvals backed by mctl-api ([ac1682d](https://github.com/mctlhq/mctl-agents/commit/ac1682ddf8563ace1abc8a54a4da4ed38026acf6))
* **policy:** durable single-use approvals backed by mctl-api ([8da7b82](https://github.com/mctlhq/mctl-agents/commit/8da7b823e8b3abfd43799399cffb62a0c979abe1))
* **work-context:** persist sealed ContextSnapshots to mctl-api ([50493db](https://github.com/mctlhq/mctl-agents/commit/50493dbebc9e120984c7f81506c861d9eb958910))
* **work-context:** persist sealed ContextSnapshots to mctl-api ([#431](https://github.com/mctlhq/mctl-agents/issues/431)) ([fe6c05d](https://github.com/mctlhq/mctl-agents/commit/fe6c05d963bb5c66cefc170121e579bf7952ab35))
* **work-context:** take the execution identity from the work-item store ([5ce1bf6](https://github.com/mctlhq/mctl-agents/commit/5ce1bf6d6610dc00b58bbfd6cfd93d94560ef656))
* **work-context:** take the execution identity from the work-item store ([1124668](https://github.com/mctlhq/mctl-agents/commit/112466888dcf5151c416e5551721e640ac28d6d3))


### Bug Fixes

* **agents:** address P1/P2 codex findings on issue-404-devloopworkflow-never-calls-continue-as-v2 ([ff28dde](https://github.com/mctlhq/mctl-agents/commit/ff28dde4e75e9021719447d892fe6cd81683a9a7))
* **agents:** address P1/P2 codex findings on issue-404-devloopworkflow-never-calls-continue-as-v2 ([0e4bcf1](https://github.com/mctlhq/mctl-agents/commit/0e4bcf1d6391d236b4b59d81cc310af7488f2273))
* bound the clarification wait absolutely, retire foreign and exhausted leftovers, seal the remaining review gaps ([efbeee4](https://github.com/mctlhq/mctl-agents/commit/efbeee4fbb878033723552bd341ccbd3f8ef7f43))
* **devloop:** read issue comments over REST so ack markers are recognised ([abf5ea2](https://github.com/mctlhq/mctl-agents/commit/abf5ea215e10e546be74facfd26a580d36bab930))
* **devloop:** read issue comments over REST so ack markers are recognised ([35a8334](https://github.com/mctlhq/mctl-agents/commit/35a8334dbeb799e88c701820224d24d00cae1ce4)), closes [#444](https://github.com/mctlhq/mctl-agents/issues/444)
* **devloop:** reuse _parse_issue_url and drop the pointless f-string ([85050e5](https://github.com/mctlhq/mctl-agents/commit/85050e54d60bb759deed0d7acf307a16f760f13d))
* **governance:** gate unknown mctl tools, loud refused acks ([3b3e5dc](https://github.com/mctlhq/mctl-agents/commit/3b3e5dc4d990c8de7748cbc9c544bc5868be056e))
* honour abandon inside the human-input park, record early endings, register the fake in [#408](https://github.com/mctlhq/mctl-agents/issues/408) fixtures ([94b976c](https://github.com/mctlhq/mctl-agents/commit/94b976cea0f260449ca7e2d7d9acf13c5cfd6a29))
* **human-input:** enforce the content address on read, bound resumes workflow-side, skip stale requests ([7414b44](https://github.com/mctlhq/mctl-agents/commit/7414b445bca191e0e638871ed47a4049ff51c4b8))
* **identity:** checker reads the writer's agent source; require mode raises at options build ([adb1c9a](https://github.com/mctlhq/mctl-agents/commit/adb1c9ae2ffb5ccd71377f027c5b0ff3b1c547d5))
* **identity:** require mode covers the unset-env header path; compare_digest takes bytes ([d37bea7](https://github.com/mctlhq/mctl-agents/commit/d37bea724bd00f047166a8383b7ce8a6d6c8d4ec))
* **identity:** require mode fails closed through the drivers' degrade handlers ([86fb8e8](https://github.com/mctlhq/mctl-agents/commit/86fb8e8eb066c4320939d1b487ca5deee85275db))
* **identity:** ruff blank lines, warn-dedupe keyed on failure text, fallback degrade test ([5096c8e](https://github.com/mctlhq/mctl-agents/commit/5096c8ed034a01f28707c973ccd4cb2028c47ff7))
* **identity:** write_status_yaml fallback degrades like every other call site ([8f984d7](https://github.com/mctlhq/mctl-agents/commit/8f984d766ca08aaf3ba801db04077ed49c5f69d0))
* **implementer:** a skip inside an open quota window is still rate-limited ([2650a56](https://github.com/mctlhq/mctl-agents/commit/2650a56d21733eda0fb2c621eef6c6d6e89aaaf6))
* **implementer:** an out-of-range reset epoch degrades to an unknown reset ([f44d220](https://github.com/mctlhq/mctl-agents/commit/f44d220dbdd17477a063f06fcdffa2b940883ed8))
* **implementer:** classify quota-exhausted runs as rate_limited, not no-commits ([6f3c705](https://github.com/mctlhq/mctl-agents/commit/6f3c7058397dbd3b9421392f79378a3754bbd3d2))
* **implementer:** classify quota-exhausted runs as rate_limited, not no-commits ([#364](https://github.com/mctlhq/mctl-agents/issues/364)) ([db62c79](https://github.com/mctlhq/mctl-agents/commit/db62c7979885e88f44fdf16c72f85a1b25f979d4))
* **implementer:** keep account_label total for an auth with no named variable ([8876e17](https://github.com/mctlhq/mctl-agents/commit/8876e1715d5f4a49ce52470b67c6f0ee3ab71eff))
* **implementer:** keep the work when the quota runs out after the agent committed ([70f1cb8](https://github.com/mctlhq/mctl-agents/commit/70f1cb8ccc86edd51ce00f192f03ba7dfbf24184))
* **implementer:** one rate-limit prefix on a skip, and say why the block still reaches gitops ([19d3407](https://github.com/mctlhq/mctl-agents/commit/19d34079c2e9ceb5725fd7e104d4bfea9018070a))
* **implementer:** skip only on an explicit account label, never a derived one ([b7edb4e](https://github.com/mctlhq/mctl-agents/commit/b7edb4e541d022574625ec866a993c5a8dba981b))
* **implement:** keep the execution row on a 4xx and prove the clamp check reads the real values file ([1725278](https://github.com/mctlhq/mctl-agents/commit/172527861d82fd4768f2ba2a18f6f3d65292be24))
* **observability:** measure first chat turn from its input; close guard gaps ([74472dd](https://github.com/mctlhq/mctl-agents/commit/74472ddc24451e6ddc62bbba87038a1aba46a274))
* **policy:** gate trigger_issue; retry an undecided checkpoint instead of acking it ([55ea6cc](https://github.com/mctlhq/mctl-agents/commit/55ea6ccc1d3f86ba224c80d6dc6a08ad613cd6e0))
* **policy:** keep blocking approval I/O off the SDK event loop ([dfb74b4](https://github.com/mctlhq/mctl-agents/commit/dfb74b4c4b2449fac81fa2d8f7a4bf612c31afbe))
* prune rejected answers, keep the projection live, retire same-issue leftovers by start time ([0fde4c7](https://github.com/mctlhq/mctl-agents/commit/0fde4c767cda31ee2f8159ea44cc7c5295fb6f70))
* repair merge damage, carry human-input outcome across the watch hop ([2874c23](https://github.com/mctlhq/mctl-agents/commit/2874c233dc4e0f731dc08ece1eba4aef226d3645))
* **service-skills:** bound manifest.yaml read, full-prefix R12 containment, aggregate ceiling key ([c790ba2](https://github.com/mctlhq/mctl-agents/commit/c790ba24c98301011c61920700347a6b5021bf0c))
* **service-skills:** derive the R6 pin in the resolver instead of verifying, under the kill switch ([7da9e3f](https://github.com/mctlhq/mctl-agents/commit/7da9e3fa962fa6d75d77b14f9b8d293590147616))
* **service-skills:** make the declarative pin a pure function of the Task ([e27d10d](https://github.com/mctlhq/mctl-agents/commit/e27d10d76f94a6ebab2c169fa91589c4e9dd716a))
* **service-skills:** R6 on adopted branches and the declarative path, wiring tests, CLI agent guard ([356871b](https://github.com/mctlhq/mctl-agents/commit/356871b1db14c0393bec4324aa0b36b216e79b08))
* **service-skills:** render-time id neutralization, root-declared skill rejection, CLI gate hardening ([a6eeaa7](https://github.com/mctlhq/mctl-agents/commit/a6eeaa70569929bd75608fb3d74d94a508fe068f))
* **service-skills:** untrusted prompt text cannot forge a service_skills block ([b416bc0](https://github.com/mctlhq/mctl-agents/commit/b416bc0d1a676561680e11b6ccea9e73ec7777e9))
* **work-context:** a retry's prior-pointer lookup is never a divergence; bound store ids ([cab82d7](https://github.com/mctlhq/mctl-agents/commit/cab82d710066a3ec725bb49a71b03e9d4db1f165))
* **work-context:** an unverifiable 409 is UNKNOWN, not a divergence ([2b2e66b](https://github.com/mctlhq/mctl-agents/commit/2b2e66bd3dfcee13d8e3513acc75e7a1c66e2d0c))
* **work-context:** carry the binding across merge-watch hops, cross-check the work item's issue ([b82be1d](https://github.com/mctlhq/mctl-agents/commit/b82be1d74d92a68f2842f0a4f163a255205b4b24))
* **work-context:** complete-ledger check, shared issue-URL rule, honest accepted ([a7ae668](https://github.com/mctlhq/mctl-agents/commit/a7ae6686b35359b5544ad7d1f36237306a8377e3))
* **work-context:** fail closed on resume provenance, guard the approve flip, and seal work_context ([6858c93](https://github.com/mctlhq/mctl-agents/commit/6858c931af30960ff5a99092b2df437c6d2fe1ab))
* **work-context:** ignore execution phase; docstring and fixture-read nits ([135823b](https://github.com/mctlhq/mctl-agents/commit/135823b02c15f178e21379f231e3c3c058a2981d))
* **work-context:** ledger must end on the view's latest execution ([8f9d252](https://github.com/mctlhq/mctl-agents/commit/8f9d252cba590145168d65119d7c4b08c270a668))
* **work-context:** mirror mctl-api workitem/v1 as served ([ecb04d7](https://github.com/mctlhq/mctl-agents/commit/ecb04d7c4371e7c786d9c7e00198f4cd3fa643f8))
* **work-context:** mirror mctl-api workitem/v1 as served ([dcaed49](https://github.com/mctlhq/mctl-agents/commit/dcaed497f99a0f7ac4644f30491f4c53204dd14e)), closes [#452](https://github.com/mctlhq/mctl-agents/issues/452)
* **work-context:** pin the ledger reconciliation; make attach=False local ([a5cdd0b](https://github.com/mctlhq/mctl-agents/commit/a5cdd0b827a2d32cf32e813bdd5196758a74b97c))
* **work-context:** pin the resume-from self-exclusion; normalise MCTL_ENGINE ([5a44af8](https://github.com/mctlhq/mctl-agents/commit/5a44af80bd2aa9a919974e322b2b71d1f344bbc6))
* **work-context:** reject foreign gap resumes, tolerate kindless payload blocks, compare issue identities ([1459dc4](https://github.com/mctlhq/mctl-agents/commit/1459dc4fbb6068095f86d35dc84913948e3e0903))
* **work-context:** reject gap resumes against the carried pending window, bound the id-shaped inputs ([63c5747](https://github.com/mctlhq/mctl-agents/commit/63c57474a35ee1df305598e3f76bbb70a962446f))
* **work-context:** releasable bounded re-approval parks, tolerant verdicts, real prior-execution correlation ([84ceb4d](https://github.com/mctlhq/mctl-agents/commit/84ceb4dc34555534feef6af3c96f7958a9480e0f))
